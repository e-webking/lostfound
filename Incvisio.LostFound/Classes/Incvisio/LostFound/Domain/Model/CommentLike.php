...
class CommentLike {
     ...
     * @ORM\ManyToOne(inversedBy="commentLike")
     */
    protected $user;
     ...
     */
    protected $likedComment;

    /**
     * @return string
     */
    public function getLikedComment() {
        return $this->likedComment;
    }

    /**
     * @param string $likedComment
     * @return void
     */
    public function setLikedComment($likedComment) {
